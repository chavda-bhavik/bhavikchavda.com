...
export const Highlight: React.FC<HighlightProps> = ({}) => {
    return (
        <div className="flex flex-col-reverse md:flex-row h-full items-center my-32 space-y-reverse space-y-4 md:space-y-0">
            <h1 className="font-serif font-medium text-2xl md:text-2xl lg:text-3xl w-9/12">
