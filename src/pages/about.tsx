...
const AboutPage = () => (
  <Fragment>
    ...
    <p>
      ...
      . I code in Javascript, Typescript, NodeJS and ReactJS while keeping Web
      Performance, Accessibility and SEO in mind. While not coding i like to
      read books and create posts on various topics. You can browse my all posts
      on <NavLink
        className="link"
        link={links.linkedIn}
        type="external"
